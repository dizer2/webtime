                ...
                <div className="header__menu-row">
                    <div className="header__menu-nav">
                        <div className="header__menu-list">
                            <Link to={"/"} >
                                <div onClick={clearBodyClasses} className="header__menu-item">
                            ...
                            {Object.values(pagesData[currentPage].menu).map((menuItem, index) => (
                                <Link key={index + 1} to={menuItem.otherPage ? `/${menuItem.goTo}` : ""} onClick={() => handleScrollToSection(menuItem.goTo)} className="header__menu-item">
